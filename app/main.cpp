...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("LanHouse Cloud Gaming");
    QCoreApplication::setOrganizationDomain("lanhousecloudgaming.com.br");
    QCoreApplication::setApplicationName("LanHouse Native");
    ...
    SDL_SetHint(SDL_HINT_AUDIO_DEVICE_APP_NAME, "LanHouse Native");
    SDL_SetHint(SDL_HINT_APP_NAME, "LanHouse Native");
